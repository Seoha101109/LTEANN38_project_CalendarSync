...
- 구글 폼/설문/투표 마감, 개인 메시지(DM)나 메일로 참가 의사를 밝혀야 하는 모집/신청 마감일, 개인 짐 정리, 성적 확인 및 정정 기간, 이의신청 기간 등 '사용자의 행동이 필요한 모든 마감/기간'은 중요하므로 has_schedule=True로 설정하고 confidence 높여.
